...
<footer style="background-color: #eee; padding: 1rem 0.5rem">
		...
		<div class="wrapper" style="padding-top: 0;">
			<div class="footer-credits-sponsors">
				...
				<div class="footer-credits text-widget">
					...
					<p class="has-text-align-left" style="font-size: 14px;"><strong>Reporters:</strong> Brittany Carloni, Zoey Elwood, Audrey Lopez-Stane, Tom Kertscher</p>
	...
	<div class="site-info">			
		<div class="wrapper site-info-contain">
			<span class="copyright">© {new Date().getFullYear()} Wisconsin Watch. All rights reserved.</span>				
